...
export default function MessageMarkdown({ text, role = "ai", showActions = true }) {
  const isAi = role === "ai";
  const canShowActions = isAi && showActions;
    ...
    <div className={`message-content ${isAi ? "message-ai-rich" : "message-user-rich"}`}>
      ...
      {canShowActions && (
        <div className="message-actions">
          <CopyButton text={text} label="Copy all" title="Copy full answer" />
